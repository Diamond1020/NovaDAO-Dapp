...
const addTokenToWallet = (tokenSymbol, tokenAddress) => async () => {
  if (window.ethereum) {
    ...
    // NOTE (appleseed): 33T token defaults to sNova logo since we don't have a 33T logo yet
    let tokenPath;
    // if (tokenSymbol === "Nova") {
...
function OhmMenu() {
  ...
  const SNova_ADDRESS = addresses[networkID].SHEC_ADDRESS;
  const Nova_ADDRESS = addresses[networkID].HEC_ADDRESS;
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="Nova" aria-describedby={id}>
            ...
            <Fade {...TransitionProps} timeout={100}>
              <Paper className="ohm-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  <Link
                    href={`https://pancakeswap.finance/swap?inputCurrency=${daiAddress}&outputCurrency=${Nova_ADDRESS}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                  ...
                  {/* <Link href={`https://abracadabra.money/pool/10`} target="_blank" rel="noreferrer">
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
                        Wrap sNova on Abracadabra <SvgIcon component={ArrowUpIcon} htmlColor="#A3A3A3" />
                      </Typography>
                    </Button>
                  </Link> */}
                </Box>
                ...
                {/* <Box component="div" className="data-links">
                  ...
                  <Link href={`https://dune.xyz/shadow/Olympus-(Nova)`} target="_blank" rel="noreferrer">
                    <Button size="large" variant="contained" color="secondary" fullWidth>
                      <Typography align="left">
