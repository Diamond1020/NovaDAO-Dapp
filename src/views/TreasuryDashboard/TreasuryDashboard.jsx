          ...
          <Paper className="ohm-card">
            <Box display="flex" flexWrap="wrap" justifyContent="space-between" alignItems="center">
              ...
              <Box className="metric price">
                ...
                <Typography variant="h5">
                  {/* appleseed-fix */}
                  {marketPrice ? formatCurrency(marketPrice, 6) : <Skeleton type="text" />}
                </Typography>
              </Box>
              ...
              <Box className="metric runway">
                <Typography variant="h6" color="textSecondary">
                  ...
                  <InfoTooltip
                    message={
                      "Runway, is the number of days sNova emissions can be sustained at a given rate. Lower APY = longer runway"
                    }
                  />
                </Typography>
                <Typography variant="h5">
            ...
            <Grid item lg={6} md={6} sm={12} xs={12}>
              <Paper className="ohm-card">
                <Chart
                  ...
                  headerText="Protocol Owned Liquidity Nova-DAI"
