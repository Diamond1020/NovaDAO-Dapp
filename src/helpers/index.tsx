...
export async function getMarketPrice({ networkID, provider }: IBaseAsyncThunk) {
  const nova_dai_address = nova_dai.getAddressForReserve(networkID);
  const pairContract = new ethers.Contract(nova_dai_address, PairContract, provider);
